<html>
    ...
    <div class="header">
            ...
            <div class="container">
                <div class="top-header-left">
                    <?php if(isset($this->session->user)) { ?>
                        <a href="<?php echo base_url()."/index.php/ControllerProkerAdmin";?>"><img src="<?php echo base_url()."assets/";?>images/logo-spkm.png" width="80" /></a>
                    <?php } else { ?>
                        <img src="<?php echo base_url()."assets/";?>images/logo-spkm.png" width="80" />
                    <?php } ?>
                </div>
                <div class="top-header-left" style="color:white; padding-left:2em;"><h3>Admin SPKM</h3></div>
                <div class="top-header-right">
                    <div class="down-top"></div>
                    <?php if (isset($this->session->user)) { ?>
                       <ul class="support">
                            <li><i class="fa fa-upload fa-1x" aria-hidden="true"></i><a href="<?php echo base_url()."ControllerProkerAdmin/showupload/".$this->session->user;?>"><span>Upload Proker</span></a></li>
                        </ul>
                        <ul class="support">
                            <li><i class="fa fa-user fa-1x" aria-hidden="true"></i><a href="<?php echo base_url()."ControllerAdmin/showprofil/".$this->session->user;?>"><span>Hi, Admin </span><?php echo $this->session->nama;?></a></li>
                        </ul>
                        <ul class="support">
                            <li><i class="fa fa-sign-out fa-1x" aria-hidden="true"></i><a onclick="return confirm('Apakah Anda yakin ingin keluar dari SPKM?')" href="<?php echo base_url()."ControllerLogout/logout/admin";?>"><span></span>Logout</a></li>
                        </ul>
                    <?php } else { ?>
                        <ul class="support">
                            <li><i class="fa fa-sign-in fa-1x" aria-hidden="true"></i><a href="<?php echo base_url()."ControllerLogin/login/admin";?>">LOGIN</a></li>
                        </ul>
                        <ul class="support">
                            <li><i class="fa fa-user fa-1x" aria-hidden="true"></i><a href="<?php echo base_url()."ControllerSignUp/showregister/admin";?>"><span> </span>REGISTER</a></li>
                        </ul>
                    <?php } ?>
        ...
        <div class="bottom-header">
            <div class="container">
                <div class="top-header-right">
                    <form action="<?php echo base_url()."ControllerProkerAdmin/cariProker/"; ?>" method="get">
                        Kementrian
